...
знания2.добавить(new Эквивалентность(БЛжец,new Не(БРыцарь)));
    // Добавьте 
...
знания3.добавить(new Эквивалентность(АЛжец, new Не(АРыцарь)));
...
знания2.добавить(new Эквивалентность(ВЛжец,new Не(ВРыцарь)));
    // Добавьте 
